-- Insert sample listings with proper photos and JSONB amenities
...
(
  ...
  '["wifi", "kitchen", "air_conditioning", "tv", "washer"]'::jsonb,
  true
),
(
  (SELECT user_id FROM profiles LIMIT 1),
  ...
  '["wifi", "kitchen", "pool", "parking", "fireplace"]'::jsonb,
  true
),
(
  (SELECT user_id FROM profiles LIMIT 1),
  ...
  '["wifi", "kitchen", "hot_tub", "gym", "fireplace", "heating"]'::jsonb,
  true
),
(
  (SELECT user_id FROM profiles LIMIT 1),
  ...
  '["wifi", "kitchen", "air_conditioning", "washer", "dryer"]'::jsonb,
  true
),
(
  (SELECT user_id FROM profiles LIMIT 1),
  ...
  '["wifi", "kitchen", "fireplace", "parking"]'::jsonb,
  true
),
(
  (SELECT user_id FROM profiles LIMIT 1),
  ...
  '["wifi", "kitchen", "air_conditioning", "tv"]'::jsonb,
  true
);